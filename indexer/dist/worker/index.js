...
const readContractSepolia = new ethers.Contract(process.env.SEPOLIA_BRIDGE_CONTRACT, sepoliaBridgeABI, providerSepolia);
const writeContractSepolia = readContractSepolia.connect(wallet);
const readContractPolygon = new ethers.Contract(process.env.POLYGON_BRIDGE_CONTRACT, polygonBridgeABI, providerPolygon);
