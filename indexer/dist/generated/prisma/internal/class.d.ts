...
export interface PrismaClient<in LogOpts extends Prisma.LogLevel = never, in out OmitOpts extends Prisma.PrismaClientOptions['omit'] = undefined, in out ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> {
    ...
    /**
 * `prisma.networkStatus`: Exposes CRUD operations for the **NetworkStatus** model.
  * Example usage:
  * ```ts
  * // Fetch zero or more NetworkStatuses
  * const networkStatuses = await prisma.networkStatus.findMany()
  * ```
  */
    get networkStatus(): Prisma.NetworkStatusDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
    ...
    /**
     * `prisma.burn`: Exposes CRUD operations for the **Burn** model.
      * Example usage:
      * ```ts
      ...
      * ```
      */
    get burn(): Prisma.BurnDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
}
